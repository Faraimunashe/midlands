<template>
    <div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600">
      ...
      <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
        ...
        <form @submit.prevent="handleLogin">
          ...
          <!-- Login Button -->
          <button type="submit" class="w-full bg-purple-600 text-white py-3 rounded-lg font-semibold text-lg transition duration-300 transform hover:bg-purple-700 hover:shadow-lg hover:-translate-y-1">
            Log In
          </button>
        </form>
      ...
      <footer class="mt-6 text-center text-white text-sm">
        &copy; {{ currentYear }} Midlands Province | Developed by <a href="#" class="text-sm text-gray-600 hover:text-gray-800">Faraimunashe</a>
      </footer>
  ...
  export default {
    ...
    methods: {
      handleLogin() {
        // Handle the login action here, e.g., API call
