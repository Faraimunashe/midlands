    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mb-6">
        <div class="flex justify-between items-center">
          <h2 class="text-3xl font-semibold text-gray-800">Department Management</h2>
          <!-- Add User Button -->
          <a
      ...
      <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <table class="min-w-full bg-white">
          ...
          <tbody>
            ...
            >
              <td class="py-3 px-4 border-b border-gray-200 text-sm text-gray-800">{{ department.id }}</td>
              <td class="py-3 px-4 border-b border-gray-200 text-sm text-gray-800">{{ department.name }}</td>
              <td class="py-3 px-4 border-b border-gray-200 text-sm text-gray-800 flex space-x-2">
                ...
                <button
                  @click="showDeleteModal(department.id)"
      ...
      >
        <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
          ...
          <p class="text-gray-600 mt-4">Are you sure you want to delete this department?</p>
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      const departmentIdToDelete = ref(null);

      const showDeleteModal = (userId) => {
        departmentIdToDelete.value = userId;
        isModalVisible.value = true;
      };

      const handleDelete = () => {
        router.delete(`/departments/${departmentIdToDelete.value}`, {
          preserveState: true,
          onFinish: () => {
